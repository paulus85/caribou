...
const gridContent = [
    {
        text: (
            <>
                Un brunch copieux, à base de produits <b>frais et locaux</b>, et
                avec un bon goût de <b>Québec</b> !
            </>
        ),
        image: ForkIcon,
    },
    {
        text: (
            <>
                Le <b>samedi et dimanche</b>, de <b>10h30 à 14h00</b>
            </>
        ),
        image: ClockIcon,
    },
    {
        text: (
            <>
                Pensez à <b>réserver</b> (surtout pour le dimanche) au
                02&nbsp;00&nbsp;00&nbsp;00&nbsp;00 ou sur Instagram.
            </>
        ),
        image: CalendarIcon,
    },
...
function Brunch() {
    return (
        <Layout heroImage={HeroImage} text={'Brunch'}>
            <div className="grid grid-cols-[minmax(0,_4fr)_minmax(0,_7fr)] my-32 max-w-2xl mx-auto gap-y-5 px-5 items-center">
                {gridContent.map((value) => (
                    <Fragment key={value.text.key}>
                        <Image
                            src={value.image}
                            width={50}
                            alt={'Fork'}
            ...
            <div className="bg-[#EEE9DC] text-[#584C43] py-24">
                <div className="flex flex-col max-w-2xl px-5 mx-auto items-center">
                    ...
                    <h3 className="text-[#584C43] uppercase tracking-widest mb-3 text-2xl">
                        À boire
                    </h3>
                    <p className="text-[#584C43]">
                        Un café/thé et jus d’orange
                    </p>
                    <Image
                        src={PlusIcon}
                        width={50}
                    ...
                    <p className="text-[#584C43]">
                        Une verrine de panna cotta et un scone
                    </p>
                    <Image
                        src={PlusIcon}
                        width={50}
